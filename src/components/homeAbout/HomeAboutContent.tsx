    ...
    <>
      ...
      <div>
        <p className="text-[#64656a] text-base tracking-wider leading-[28px] text-justify">
          ...
          Our seamless services are designed to provide a hassle-free experience for our client&apos;s, from the initial consultation to the final handover. We believe that every project is unique, and we offer personalized attention to ensure that each clients specific needs and preferences are met with precision and care.
